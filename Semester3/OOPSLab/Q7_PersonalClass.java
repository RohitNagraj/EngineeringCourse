...
class Q7_PersonalClass{
	...
	Q7_PersonalClass (String name, String education, int age, int yearsOfExperience, int noOfLoans, int loanAmount, int basic, int da, int hra)
	{
		this.name = name;
		...
		while(true)
		{
			...
			switch (choice)
			{
				case 1:
					...
					personalDetails[counter++] = new Q7_PersonalClass(name, education, age, yearsOfExperience, noOfLoans, loanAmount, basic, da, hra);
